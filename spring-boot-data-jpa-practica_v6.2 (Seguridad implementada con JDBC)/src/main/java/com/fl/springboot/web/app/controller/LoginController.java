...
public class LoginController {
	...
	public String login(@RequestParam(value = "error", required = false)String error, @RequestParam(value = "logout", required = false)String logout,
		...
		if(error != null) {
			model.addAttribute("error", "Error: El usuario o contraseña, son incorrectos. Por favor, vuelva a intentarlo.");
		}
		if(logout != null) {
		...
		if(principal != null) {
			flash.addFlashAttribute("info", "La sesión se encuentra iniciada");
			return "redirect:/";
		}
